...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <link rel="shortcut icon" href="/user-monkey/favicon.ico">
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="panel panel-default">
                <div class="panel-heading"><h2>Please enter your password and new email address in the form below</h2><i class="fa fa-link fa-1x"></i></div>
                <div class="panel-body"  style="padding: 15px 20px;">
                    <div style="display: block; width: 260px; margin: 0 auto;">
                        <form action="/user-monkey/actions/change-email.php" method="post" name="change-email">
                            <input type="password" name="password" placeholder="Password"
                                   id="password" class="simple-tb" required="true"/><br /><br />
                            <input type="text" name="email" placeholder="New Email Address"
                                   id="email" class="textbox simple-tb" required="true"/><br><br>
                            <input type="retypeEmail" name="retypeEmail" placeholder="Retype Email Address"
                                   id="retypeEmail" class="textbox simple-tb" required="true"/><br /><br />
