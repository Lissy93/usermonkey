    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="panel panel-default">
                <div class="panel-heading"><h2>Please choose a new password and fill out the form below</h2><i class="fa fa-link fa-1x"></i></div>
                <div class="panel-body"  style="padding: 15px 20px;">
                    <div style="display: block; width: 260px; margin: 0 auto;">
                        <form action="/user-monkey/actions/change-password.php" method="post" name="change-password">
                            <input type="password" name="oldPassword" placeholder="Old Password"
                                   id="suOldPassword" class="simple-tb" required="true"/><br /><br />
                            <input type="password" name="password" placeholder="Password"
                                   id="suPassword" class="textbox simple-tb" required="true"/><br><br>
                            <input type="password" name="confPassword" placeholder="Confirm Password"
                                   id="suConfPassword" class="textbox simple-tb" required="true"/><br /><br />
